...
void ReadKeyboard(void)
{
	...
	{
		// In network games, update only our local player's steering
		gPlayerInfo[gMyNetworkPlayerNum].analogSteering = GetAnalogSteering(0);
	}
	else
	{
		// Local game: update all local players
